<template>
  <div>
    <p><strong>DATE OF LAST UPDATE: FEBRUARY 10, 2023</strong><br/>
      ...
      a purchase from {{ domain }} (the &ldquo;Site&rdquo;).<br/>
      <br/>
      ...
      Site. We refer to this automatically-collected information as &ldquo;Device Information&rdquo;.<br/>
      <br/>
      We collect Device Information using the following technologies:</p>

    <ul>
      <li>&nbsp;&ldquo;Cookies&rdquo; are data files that are placed on your device or computer and often include an
        anonymous unique identifier. For more information about cookies, and how to disable cookies, visit
        http://www.allaboutcookies.org.
      </li>
      <li>&nbsp;&ldquo;Log files&rdquo; track actions occurring on the Site, and collect data including your IP address,
        browser type, Internet service provider, referring/exit pages, and date/time stamps.
      </li>
      <li>&nbsp;&ldquo;Web beacons&rdquo;, &ldquo;tags&rdquo;, and &ldquo;pixels&rdquo; are electronic files used to
    ...
    <p><br/>
      ...
      credit card numbers), email address, and phone number. We refer to this information as &ldquo;Order Information&rdquo;.<br/>
      <br/>
      When we talk about &ldquo;Personal Information&rdquo; in this Privacy Policy, we are talking both about Device
      Information and Order Information.<br/>
      <br/>
    ...
    <p><br/>
      ...
      above. We also use Google Analytics to help us understand how our customers use the Site -- you can read more
      about how Google uses your Personal Information here: https://www.google.com/intl/en/policies/privacy/. You can
      also opt-out of Google Analytics here: https://tools.google.com/dlpage/gaoptout.<br/>
      <br/>
      Finally, we may also share your Personal Information to comply with applicable laws and regulations, to respond to
      a subpoena, search warrant or other lawful request for information we receive, or to otherwise protect our rights.<br/>
      <br/>
      ...
      you can visit the Network Advertising Initiative&rsquo;s (&ldquo;NAI&rdquo;) educational page at
    ...
    <p><br/>
      ...
      opt-out portal at: http://optout.aboutads.info/.<br/>
      <br/>
      <strong>DO NOT TRACK</strong><br/>
      Please note that we do not alter our Site&rsquo;s data collection and use practices when we see a Do Not Track
      signal from your browser.<br/>
      <br/>
      ...
      contact us through the contact information below.<br/>
      <br/>
      ...
      you ask us to delete this information.<br/>
      <br/>
      ...
      please contact us by e-mail at {{ $store.state.store.email }} or by mail using the details provided below:</p>
