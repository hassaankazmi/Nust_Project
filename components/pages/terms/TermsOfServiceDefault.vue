<template>
  <div>
    <p><strong>DATE OF LAST UPDATE: FEBRUARY 10, 2023</strong><br/>
      <br/>
      <br/>
      <strong>OVERVIEW</strong><br/>
      <br/>
      This website is operated by {{ $store.state.store.storeName }}. Throughout the site, the terms &ldquo;we&rdquo;,
      &ldquo;us&rdquo; and &ldquo;our&rdquo; refer to {{ $store.state.store.storeName }}.
      {{ $store.state.store.storeName }} offers this website, including all information, tools and services available
      from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies, and notices
      stated here.<br/>
      <br/>
      By visiting our site and/ or purchasing something from us, you engage in our &ldquo;Service&rdquo; and agree to be
      bound by the following terms and conditions (&ldquo;Terms of Service&rdquo;, &ldquo;Terms&rdquo;), including those
      ...
      considered an offer, acceptance is expressly limited to these Terms of Service.<br/>
      <br/>
      ...
      following the posting of any changes constitutes acceptance of those changes.<br/>
      <br/>
      Our store is hosted on Shopify Inc. They provide us with an online e-commerce platform that allows us to sell our
      products and services to you.<br/>
      <br/>
      ...
      given us your consent to allow any of your minor dependents to use this site.<br/>
      <br/>
      ...
      may have limited quantities and are subject to return or exchange only according to our Return Policy.<br/>
      <br/>
      We have made every effort to display as accurately as possible the colors and images of our products that appear
      at the store. We cannot guarantee that your computer monitor&#39;s display of any color will be accurate.<br/>
      <br/>
      ...
      any product at any time. Any offer for any product or service made on this site is void where prohibited.<br/>
      <br/>
      We do not warrant that the quality of any products, services, information, or other material purchased or obtained
      by you will meet your expectations, or that any errors in the Service will be corrected.<br/>
      <br/>
      ...
      or prohibit orders that, in our sole judgment, appear to be placed by dealers, resellers or distributors.<br/>
      <br/>
      ...
      card numbers and expiration dates, so that we can complete your transactions and contact you as needed.<br/>
      <br/>
      ...
      input.<br/>
      You acknowledge and agree that we provide access to such tools &rdquo;as is&rdquo; and &ldquo;as available&rdquo;
      ...
      tools and resources). Such new features and/or services shall also be subject to these Terms of Service.<br/>
      <br/>
      ...
      edit, copy, publish, distribute, translate and otherwise use in any medium any comments that you forward to us. We
      are and shall be under no obligation :&nbsp;</p>

    <ul>
      <li>(1) to maintain any comments in confidence.</li>
      <li>(2) to pay compensation for any comments.</li>
    ...
    <p><br/>
      ...
      violates any party&rsquo;s intellectual property or these Terms of Service.<br/>
      <br/>
      ...
      and assume no liability for any comments posted by you or any third-party.<br/>
      <br/>
      ...
      <br/>
      Occasionally there may be information on our site or in the Service that contains.</p>
